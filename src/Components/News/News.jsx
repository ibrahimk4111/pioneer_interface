  ...
  return (
    <Link to={`/detailed_service/${news.id}`}>
      <div className='flex justify-center items-center py-3'>
        <div className="h-[100%] w-[95%] cursor-pointer border-2 border-slate-100 shadow-xl transition hover:scale-95 duration-500">
          ...
          <div className=' px-5 py-1 flex items-center gap-3 border-t-2 border-slate-300'>
