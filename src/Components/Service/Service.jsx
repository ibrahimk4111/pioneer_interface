  ...
  return (
    <Link to={`/detailed_service/${service.id}`}>
      <div className='flex justify-center items-center py-3'>
        <div className="md:h-[430px] h-[400px] w-[95%] cursor-pointer hover:bg-bg-card hover:text-white rounded-md transition duration-500 ease-in-out hover:scale-105 shadow-xl">
          ...
          <div className="p-5">
            ...
            <p className="md:text-lg text-base line-clamp-5">{service.short_Description}</p>
          </div>
